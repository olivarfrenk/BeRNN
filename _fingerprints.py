...
for t_idx, threshold in enumerate(setup['thresholds']):
    ...
    ####################################################################################################################
    # head: Apply fingerptinting methods
    ####################################################################################################################
...
if setup['createBrainAverages']:
    # ###################################################################################################################
    # head: Preprocess brain averages over tasks
    # ###################################################################################################################
